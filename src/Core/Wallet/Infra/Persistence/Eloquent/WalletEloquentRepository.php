...
{
    public function __construct(protected WalletModel $model, protected UnitOfWorkInterface $unitOfWork)
    {
    }
    ...
    {
        $wallet = $this->model->find($entityId->value());
        return $wallet ? WalletModelMapper::toEntity($wallet) : null;
    }
    ...
    public function findByCriteria(CriteriaInterface $criteria): ?Entity
    {
        ...
        $user = $query->first();
        return $user ? WalletModelMapper::toEntity($user) : null;
    }
